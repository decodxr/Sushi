...
export const createOrderSchema=z.object({
  ...
  fulfillmentType:z.enum(['delivery','pickup']),paymentMethod:z.enum(['pix','cash','card_on_delivery']),changeFor:z.number().positive().optional(),couponCode:z.string().trim().max(30).optional(),generalNotes:z.string().trim().max(500).optional(),deliveryZoneId:z.string().uuid().optional(),
